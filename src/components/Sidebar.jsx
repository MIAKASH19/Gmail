...
const Sidebar = () => {
  return (
    <div className='sidebar'>
      <Button className='compose-btn' startIcon={<EditRoundedIcon font-size="large" />}>
        Compose
      </Button>
      <SidebarOption selected={true} Icon={InboxIcon} title="Inbox" number={54}/>
      <SidebarOption Icon={StarBorderOutlinedIcon} title="Starred" number={89}/>
      <SidebarOption Icon={AccessTimeIcon} title="Snoozed" number={34}/>
      <SidebarOption Icon={SendIcon} title="Sent" number={75}/>
      <SidebarOption Icon={InsertDriveFileOutlinedIcon} title="Drafts" number={91}/>
